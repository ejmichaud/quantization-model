...
# coding: utf-8
"""
This script trains MLPs on multiple sparse parity problems at once, imposing
a uniform distribution over the subtasks, rather than a power law.

Comments
    - now does sampling for everything except the test batch -- frequencies of subtasks are exactly distributed within test batc
"""
...
ex = Experiment("sparse-parity-v4-uniform")
